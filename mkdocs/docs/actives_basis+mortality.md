...
## Male Ill-Health Mortality Rate Parameters

## Female Ill-Health Mortality Rate Parameters
...
Parameters](#actives_basis+dill) above include a percentage
adjustment then this will also be applied to the base table in addition
to any entry in this field.

## Male Ill-Health Mortality Improvement Parameters

## Female Ill-Health Mortality Improvement Parameters
