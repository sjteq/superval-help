...
## Specify Scenario Values as differences from the Valuation Basis

## Specify Absolute Scenario Values where they differ from the Valuation Basis
...
## Use Financial Globals Parameter Set Selected at Valuation Time
